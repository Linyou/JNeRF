...
class HashEncoder(nn.Module):
    def __init__(self, n_pos_dims=3, n_features_per_level=2, n_levels=16, base_resolution=16, log2_hashmap_size=19, n_rays_per_batch=4096):
        self.cfg = get_cfg()
...
#define get_index(p0,p1,p2) {self.hash_func}
        ...
        self.encoder = GridEncode(self.hash_func_header, aabb_scale=aabb_scale, n_pos_dims=3, n_features_per_level=2,
                                  n_levels=16, base_resolution=16, log2_hashmap_size=log2_hashmap_size, using_fp16=using_fp16, n_rays_per_batch=n_rays_per_batch)
